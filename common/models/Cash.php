    ...
    public function updateStatusHardRent()
    {
        ...
        foreach ($orderProducts as $orderProduct) {
            if ($orderProduct->type<>OrderProduct::COLLECT) {
                ...
                if ((!(key_exists(Action::HARDRENT,$status)))and($order->getPaid()>0)) {
                    $orderProduct->addMovement(Action::HARDRENT,0,$this->dateTime);
                } else if ((key_exists(Action::HARDRENT,$status)) and ($order->getPaid()==0)) {
