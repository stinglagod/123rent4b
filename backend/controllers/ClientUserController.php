...
class ClientUserController extends Controller
{
     ...
     */
    public function actionView($client_id, $user_id)
    {
        return $this->render('view', [
            'model' => $this->findModel($client_id, $user_id),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['view', 'client_id' => $model->client_id, 'user_id' => $model->user_id]);
        }
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($client_id, $user_id)
    {
        $model = $this->findModel($client_id, $user_id);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($client_id, $user_id)
    {
        $this->findModel($client_id, $user_id)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($client_id, $user_id)
    {
        if (($model = ClientUser::findOne(['client_id' => $client_id, 'user_id' => $user_id])) !== null) {
            return $model;
        }
