...
class Site extends ActiveRecord
{
    ...
    public function edit($name, $domain, $telephone, $address,$email,Social $social,$timezone, MainPage $mainPage): void
    {
//        var_dump($mainPage);exit;
        $this->updated_at=0;
...
//        var_dump($this->mainPage->mainSlider[0]);
//        var_dump($mainPage->mainSlider[0]);
//        var_dump($this->mainPage);
//        exit;
